...
def init_defaults() -> Tuple[DBHandler,
    ...
    default_params = {
        ...
        'w2v': {'nlp_': fast_nlp,
                'model_path': MODEL_DEFAULT_PARAMS['w2v']['filepath'],
                'model_name_': MODEL_DEFAULT_PARAMS['w2v']['filepath'].stem,
                'index_folder_': INDEX_PATH,
                'similarity_metric': MODEL_DEFAULT_PARAMS['w2v']['similarity_metric']},
        'ft': {'model_path': MODEL_DEFAULT_PARAMS['ft']['filepath'],
               'model_name_': MODEL_DEFAULT_PARAMS['ft']['filepath'].stem,
               'index_folder_': INDEX_PATH,
               'similarity_metric': MODEL_DEFAULT_PARAMS['w2v']['similarity_metric']},
        'bert': {'nlp_': fast_nlp,
